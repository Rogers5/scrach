...
class DmozSpider(scrapy.Spider):  
    name = "house"  
    allowed_domains = ["wg.jxbuild.gov.cn"]
    ...
    for keyword in keywordList:
        ...
        start_urls.append("http://wg.jxbuild.gov.cn/dealinfo.jspx?areaid=&type=1&flag=1&keyword=" + urllib.quote(url.encode('utf-8', 'replace')) + "&pageno=1")
